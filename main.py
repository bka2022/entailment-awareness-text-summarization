...
metric = datasets.load_metric("rouge") #rouge metric
...
#base
model_before_tuning = AutoModelForSeq2SeqLM.from_pretrained(model_name) #base

#n-samples
test_samples = validation_data_txt.select(range(TEST_SAMPLES))
